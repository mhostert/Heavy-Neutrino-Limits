...
#scenario_dict = {r'$\mathcal{Z}_{ij}^{\text{duN}\ell}=1$': 1, r'$\mathcal{Z}_{ij}^{\text{duN}\ell}=V_{ij}^*$': 1}
lepton = 'e'
operator_dunl_e = fr'$\mathcal{{O}}_{{\rm{{duN}}\ell}}^{{{lepton}}}:\mathcal{{Z}}_{{ij}}^{{\rm{{duN}}\ell}}(\overline{{d}}_{{i}} \gamma^{{\mu}} u_{{j}}) (\overline{{N}} \gamma_{{\mu}} {lepton})$'
lepton = '\mu'
operator_dunl_mu = fr'$\mathcal{{O}}_{{\rm{{duN}}\ell}}^{{{lepton}}}:\mathcal{{Z}}_{{ij}}^{{\rm{{duN}}\ell}}(\overline{{d}}_{{i}} \gamma^{{\mu}} u_{{j}}) (\overline{{N}} \gamma_{{\mu}} {lepton})$'
lepton = '\\tau'
operator_dunl_tau = fr'$\mathcal{{O}}_{{\rm{{duN}}\ell}}^{{{lepton}}}:\mathcal{{Z}}_{{ij}}^{{\rm{{duN}}\ell}}(\overline{{d}}_{{i}} \gamma^{{\mu}} u_{{j}}) (\overline{{N}} \gamma_{{\mu}} {lepton})$'

lepton = 'e'
operator_lnqd_e = fr'$\mathcal{{O}}_{{\rm{{LNQd}}}}^{{{lepton}}}:\mathcal{{Z}}_{{ij}}^{{\rm{{LNQd}}}}(\overline{{L}}_{{{lepton}}} N)\epsilon (\overline{{Q_{{i}}}} d_{{j}})$'
lepton = '\mu'
operator_lnqd_mu = fr'$\mathcal{{O}}_{{\rm{{LNQd}}}}^{{{lepton}}}:\mathcal{{Z}}_{{ij}}^{{\rm{{LNQd}}}}(\overline{{L}}_{{{lepton}}} N)\epsilon (\overline{{Q_{{i}}}} d_{{j}})$'
lepton = '\\tau'
operator_lnqd_tau = fr'$\mathcal{{O}}_{{\rm{{LNQd}}}}^{{{lepton}}}:\mathcal{{Z}}_{{ij}}^{{\rm{{LNQd}}}}(\overline{{L}}_{{{lepton}}} N)\epsilon (\overline{{Q_{{i}}}} d_{{j}})$'

lepton = 'e'
operator_qunl_e = fr'$\mathcal{{O}}_{{\rm{{QuNL}}}}^{{{lepton}}}:\mathcal{{Z}}_{{ij}}^{{\rm{{QuNL}}}}(\overline{{Q_{{i}}}} u_{{j}})(\overline{{N}} L_{{{lepton}}})$'
lepton = '\mu'
operator_qunl_mu = fr'$\mathcal{{O}}_{{\rm{{QuNL}}}}^{{{lepton}}}:\mathcal{{Z}}_{{ij}}^{{\rm{{QuNL}}}}(\overline{{Q_{{i}}}} u_{{j}})(\overline{{N}} L_{{{lepton}}})$'
lepton = '\\tau'
operator_qunl_tau = fr'$\mathcal{{O}}_{{\rm{{QuNL}}}}^{{{lepton}}}:\mathcal{{Z}}_{{ij}}^{{\rm{{QuNL}}}}(\overline{{Q_{{i}}}} u_{{j}})(\overline{{N}} L_{{{lepton}}})$'

o_dic = {'duNl_e': operator_dunl_e, 'duNl_mu': operator_dunl_mu, 'duNl_tau': operator_dunl_tau,
         'LNQd_e': operator_lnqd_e, 'LNQd_mu': operator_lnqd_mu, 'LNQd_tau': operator_lnqd_tau,
         'QuNL_e': operator_qunl_e, 'QuNL_mu': operator_qunl_mu, 'QuNL_tau': operator_qunl_tau}

fb_dunl = r'Flavour blind: $\mathcal{Z}_{ij}^{\rm{duN}\ell}=1$'
fa_dunl = r'Flavour aligned: $\mathcal{Z}_{ij}^{\rm{duN}\ell}=V_{ij}^{*}$'

fb_lnqd = r'Flavour blind: $\mathcal{Z}_{ij}^{\rm{LNQd}}=1$'
fa_lnqd = r'Flavour aligned: $\mathcal{Z}_{ij}^{\rm{LNQd}}=V_{ij}^{*}$'

fb_qunl = r'Flavour blind: $\mathcal{Z}_{ij}^{\rm{QuNL}}=1$'
fa_qunl = r'Flavour aligned: $\mathcal{Z}_{ij}^{\rm{QuNL}}=V_{ij}^{*}$'

z_fb_dic = {'duNl_e': fb_dunl, 'duNl_mu': fb_dunl, 'duNl_tau': fb_dunl,
         'LNQd_e': fb_lnqd, 'LNQd_mu': fb_lnqd, 'LNQd_tau': fb_lnqd,
         'QuNL_e': fb_qunl, 'QuNL_mu': fb_qunl, 'QuNL_tau': fb_qunl}

z_fa_dic = {'duNl_e': fa_dunl, 'duNl_mu': fa_dunl, 'duNl_tau': fa_dunl,
         'LNQd_e': fa_lnqd, 'LNQd_mu': fa_lnqd, 'LNQd_tau': fa_lnqd,
         'QuNL_e': fa_qunl, 'QuNL_mu': fa_qunl, 'QuNL_tau': fa_qunl}
...
def std_savefig(fig, path, dpi=800, **kwargs):
...
def std_plot_limits(case,
    ...
    for id, limit in case.limits.iterrows():
        if (id not in skip_ids) & (limit.interp_func is not None):
            ...
            if limit.file_top == limit.file_bottom and limit.m4 is not None and limit.ualpha4 is not None:
                if ('_fb' in id):
                    ax.plot(limit.m4, limit.ualpha4, color=contour_color, dashes=test_dash, dash_capstyle='round', zorder=3, lw=LW)
                else:
                    ax.plot(limit.m4, limit.ualpha4, color=contour_color, ls='solid', zorder=3, lw=LW)
                # Filling
                ...
                # if ('bebc_barouki'==id):
                #     ax.plot(x, limit.interp_func(x), color=contour_color, ls=style_of_line, marker=style_of_marker, zorder=3, lw=LW)
                #     ax.plot(x, limit.interp_func_top(x), color=contour_color, ls=style_of_line, marker=style_of_marker, zorder=3, lw=LW)
                # else:
                if ('_fb' in id):
                #     if (limit.scenario_legend in scenario_dict):
                #         jlabel= fr'\noindent {limit.scenario_legend}'
                #         ax.plot(x, limit.interp_func(x), color=contour_color, dashes=test_dash, dash_capstyle='round', zorder=3, lw=LW, label=jlabel)
                #         #ax.plot(x, limit.interp_func_top(x), color=contour_color, dashes=test_dash, dash_capstyle='round', zorder=3, lw=LW, label=jlabel)
                #     else:
                        ax.plot(x, limit.interp_func(x), color=contour_color, dashes=test_dash, dash_capstyle='round', zorder=3, lw=LW)
                        ax.plot(x, limit.interp_func_top(x), color=contour_color, dashes=test_dash, dash_capstyle='round', zorder=3, lw=LW)
                else:
                    # if (limit.scenario_legend in scenario_dict):
                    #     jlabel= fr'\noindent {limit.scenario_legend}'
                    #     ax.plot(x, limit.interp_func(x), color=contour_color, ls='solid', zorder=3, lw=LW, label=jlabel)
                    #     #ax.plot(x, limit.interp_func_top(x), color=contour_color, ls='solid', zorder=3, lw=LW, label=jlabel)
                    # else:
                        ax.plot(x, limit.interp_func(x), color=contour_color, ls='solid', zorder=3, lw=LW)
                        ax.plot(x, limit.interp_func_top(x), color=contour_color, ls='solid', zorder=3, lw=LW)  
                # Filling
                if ('cosmo' in  id) or (limit.year is None):
                    #continue
                    ...
                    if limit.interp_func_top(x) is not None and limit.interp_func(x) is not None and U_MEAN is not None:
                        if ('_fb' in id):
                            ax.fill_between(x, limit.interp_func(x), limit.interp_func_top(x), facecolor=fill_color, edgecolor='None', alpha=test_alpha, zorder=U_MEAN)
                        else:
    ...
    # if case.flavor_blind == True:
    #     ax.text(20, 2*min(yrange), r'$\mathcal{Z}_{ij}^{\text{duN}\ell}=1$', fontsize=10)
    # else:
    #     ax.text(20, 2*min(yrange), r'$\mathcal{Z}_{ij}^{\text{duN}\ell}=V_{ij}^*$', fontsize=10)
    #ax.plot(1e-5, 1e-9, color='black', dashes=test_dash, dash_capstyle='round', zorder=3, lw=LW, label=r'$\mathcal{Z}_{ij}^{\text{duN}\ell}=1$')
    #ax.plot(1e-5, 1e-9, color='black', ls='solid', zorder=3, lw=LW, label=r'$\mathcal{Z}_{ij}^{\text{duN}\ell}=V_{ij}^*$')
    #= \mathcal{{Z}}_{{ij}}^{{\rm duN\ell}}(\overline{{d}}_i \gamma^\mu u_j) (\overline{{N}} \gamma^\mu \ell_{{{case.flavor}}})$')
    #ax.plot(1e-5, 1e-9, color='pink', ls='', zorder=3, lw=LW, label= fr'$\mathcal{{O}}_{{\rm{{duN}}\ell}}^{{\alpha}}=\mathcal{{Z}}_{{ij}}^{{\rm{{duN}}\ell}}$')
    #\mathcal{{Z}}_{{ij}}^{{\rm{{duN}}\ell}}(\overline{{d}}_{{i}} \gamma^{{\mu}} u_{{j}}) (\overline{{N}} \gamma^{{\mu}} \ell_{{e}})$'
    #flavorop = 'e'
    #operator = fr'$\mathcal{{O}}_{{\rm{{duN}}\ell}}^{{{flavorop}}}=\dfrac{{C^{{e}}_{{\rm{{duN}}\ell}}}}{{\Lambda^{{2}}}}\mathcal{{Z}}_{{ij}}^{{\rm{{duN}}\ell}}(\overline{{d}}_{{i}} \gamma^{{\mu}} u_{{j}}) (\overline{{N}} \gamma^{{\mu}} \ell_{{e}})$'
    #operator = fr'$\mathcal{{O}}_{{\rm{{duN}}\ell}}^{{{flavorop}}}:\mathcal{{Z}}_{{ij}}^{{\rm{{duN}}\ell}}(\overline{{d}}_{{i}} \gamma^{{\mu}} u_{{j}}) (\overline{{N}} \gamma^{{\mu}} {flavorop})$'

    #ax.text(2, 10*min(yrange), operator, fontsize=8)
    ax.plot(1e-5, 1e-9, color='black', dashes=test_dash, dash_capstyle='round', zorder=3, lw=LW, label=z_fb_dic['%s'%case.flavor])
    ax.plot(1e-5, 1e-9, color='black', ls='solid', zorder=3, lw=LW, label=z_fa_dic['%s'%case.flavor])
    #ax.plot(1e-5, 1e-9, color='black', ls='', zorder=3, lw=LW, label=operator)

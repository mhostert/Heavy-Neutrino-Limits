...
| 4-fermion NC     | $\mathcal{O}_{\rm ff}$   | $(\overline{f} \gamma^\mu f) (\overline{N} \gamma_\mu N)$ | ``6_NSMEFT_4fermion_NC_ff_LN.ipynb``      | [4-fermion ff: ee]()  <br /> [4-fermion ff: uu]()  <br /> [4-fermion ff: dd]()                                                                                                                                                                                                                                                                                                                            |
...
|                      | $\mathcal{O}_{\rm QN}$                    | $(\overline{Q}\_i \gamma^\mu Q\_i) (\overline{N} \gamma_\mu N)$                | ``7_NSMEFT_4fermion_NC_QN.ipynb``      | [Four fermion QN]()                                                                                                                                                                                                                                                                                                                                    |

...
| Charged Currents     | $\mathcal{O}_{\rm LNL\ell}^{\alpha\beta}$ | $(\overline{L}\_\alpha N)\epsilon (\overline{L}\_\alpha \ell\_\beta)$                                    | ``9_NSMEFT_4fermion_LNLell.ipynb``  | [Four fermion LNLell NC]()  <br />  [Four fermion LNLell CC]()                                                                                                                                                                                                                                                                                                                                |
